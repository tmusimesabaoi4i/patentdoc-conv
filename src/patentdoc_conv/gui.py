...
class App:
    """Thin tkinter wrapper around :func:`patentdoc_conv.builder.run_build`."""

    def __init__(self, root: tk.Tk, initial_dir: Optional[str] = None) -> None:
        self.root = root
        self.root.title("toHTML_PDF - 審査用 HTML/PDF 変換")
    ...
    def _build_layout(self) -> None:
        ...
        ttk.Label(outer, text="toHTML_PDF", style="Title.TLabel").pack(anchor="w")
        ttk.Label(
            outer,
