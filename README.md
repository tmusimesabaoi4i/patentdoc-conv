...
src/patentdoc-conv run --dir samples/
```
...
| 目的 | コマンド |
|---|---|
| すべて処理 | `src/patentdoc-conv run --dir samples/` |
| テキストのみ | `src/patentdoc-conv --run text --dir samples/` |
| 画像のみ | `src/patentdoc-conv --run img --dir samples/` |
| HTMLのみ作成 | `src/patentdoc-conv run --dir samples/ --skip-pdf` |
| GUIを起動 | `src/patentdoc-conv --gui` |
